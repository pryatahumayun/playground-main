...
az deployment group create --resource-group $resourceGroupName --template-file infra/main.bicep --parameters projectName=$projectName environment=$environment location=$location aksSku=$aksSku nodeCount=$nodeCount
