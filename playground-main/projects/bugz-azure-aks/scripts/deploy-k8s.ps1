...
kubectl apply -f playground-main/projects/bugz-azure-aks/k8s/namespace.yaml
kubectl apply -f playground-main/projects/bugz-azure-aks/k8s/deployment.yaml
kubectl apply -f playground-main/projects/bugz-azure-aks/k8s/service.yaml
